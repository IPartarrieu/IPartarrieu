...
Adapted from github.com/emmi-lili/emmi-lili (scripts/dotify.py). Not currently
called by the README or any workflow — kept as a standalone tool in case a
dot-matrix portrait is wanted again.
...
THEMES = {
    ...
    "dark": ("#4fb3d9", "#2f6f80", None),
    "light": ("#0e6b5c", "#7fc4d6", None),
}

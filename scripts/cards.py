...
Adapted from github.com/emmi-lili/emmi-lili (scripts/cards.py).
...
These are files in your own repo, so they render as long as GitHub renders.
    ...
    python scripts/cards.py --user IPartarrieu --out assets
...
THEMES = {
    "dark": {
        "bg": "#0d1117", "border": "#30363d", "title": "#4fb3d9",
        "text": "#c9d1d9", "muted": "#8b949e", "value": "#e6edf3",
        "accent": "#4fb3d9",
    },
    "light": {
        "bg": "#ffffff", "border": "#d0d7de", "title": "#0e6b5c",
...
LANG_COLOR = {
    ...
    "MATLAB": "#e16737", "R": "#198CE7", "TeX": "#3D6117",
}
